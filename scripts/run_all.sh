...
bash scripts/treatment.sh data/runtables/SraRunTable_PRJEB55313.txt # Downloaded, not processed.
# In progress
...
#bash scripts/treatment.sh data/runtables/SraRunTable_PRJNA764181.txt #clinical data!!!

...
Rscript scripts/effluent.R --freqmin 0.05 data/runtables/SraRunTable_PRJEB48206.txt,data/runtables/SraRunTable_PRJNA1042787.txt,data/runtables/SraRunTable_PRJNA788395.txt,data/runtables/SraRunTable_PRJNA796340.txt